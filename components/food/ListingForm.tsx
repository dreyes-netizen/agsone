...
import type { AddOn } from "@/lib/types/food";
...
export function ListingForm({
  ...
  newCutoff: string; setNewCutoff: (v: string) => void;
  ...
  newAddOns: AddOn[];
  addOnName: string; setAddOnName: (v: string) => void;
  addOnPrice: string; setAddOnPrice: (v: string) => void;
  addAddOn: () => void;
