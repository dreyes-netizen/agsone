  ...
  return (
    <section className="bg-white border border-table-border rounded-card p-4 sm:p-6 space-y-4">
      <div className="flex items-center justify-between gap-3">
        <div><h2 className="text-base font-bold text-gray-900">Type the passage</h2><p className="text-xs text-gray-500">{mode === "ranked" ? "Type as much of the passage as you can in 60 seconds. If you finish early, continue again from the start until time expires. Paste, cut and drop are disabled." : "Begin typing when you are ready."}</p></div>
